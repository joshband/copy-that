...
**Created:** `docs/testing/e2e_testing_roadmap.md`
...
- `docs/testing/e2e_testing_roadmap.md` (338 lines)
...
# 2. Manual E2E test (follow testing/e2e_testing_roadmap.md)
# - Create session
# - Upload image URLs
# - Curate colors
...
# Follow manual testing scenarios in testing/e2e_testing_roadmap.md
```
