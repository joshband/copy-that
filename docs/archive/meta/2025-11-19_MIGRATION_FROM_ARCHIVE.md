...
- archive/meta/2025-11-19_ARCHIVE_CHANGELOG.md (complete history)
- archive/ (consolidated archive; dated legacy docs organized by pipeline)
...
│       └── pipeline/             # Pipeline-organized legacy docs
│           ├── strategy/         # Roadmaps, capability/status docs
│           ├── operations/       # Build/deployment/tooling checklists
│           ├── extraction/       # Extractor patterns & preprocessing
│           ├── tokens/           # Token ontology/mappings/export (variants/)
│           ├── design/           # UI/UX notes
│           ├── testing/          # Testing strategies/guides
│           └── historical/       # Older v2.x summaries, superseded docs
│
├── archive/meta/2025-11-19_ARCHIVE_ROADMAP.md   # Original roadmap
└── archive/meta/2025-11-19_ARCHIVE_CHANGELOG.md # Complete history
```
