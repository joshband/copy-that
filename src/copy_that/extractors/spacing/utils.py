...
def infer_base_spacing_robust(
    ...
    # High gap variance often yields base_unit=1 with misleading coverage.
    # Floor to a 4pt design base and down-rank so UI does not trust noise.
    if best_base < _MIN_DESIGN_BASE_PX:
        best_base = _MIN_DESIGN_BASE_PX
        best_score = min(best_score, _SUBMIN_BASE_MAX_CONFIDENCE)
