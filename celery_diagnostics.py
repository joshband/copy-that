...
app = Celery(
    "celery_diagnostics", broker="redis://localhost:6379/1", backend="redis://localhost:6379/2"
)
...
app.conf.update(
    ...
    accept_content=["json"],
    task_routes={"celery_diagnostics.debug_task": {"queue": "debug"}},
    task_annotations={"celery_diagnostics.debug_task": {"rate_limit": "10/m"}},
)
