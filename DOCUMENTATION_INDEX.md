...
| Need | Doc |
|------|-----|
| Run locally | [start_here.md](docs/setup/start_here.md) |
| Roadmap | [MVP_EXPANSION_ROADMAP.md](docs/planning/MVP_EXPANSION_ROADMAP.md) |
| What exists in code | [CURRENT_ARCHITECTURE_STATE.md](docs/architecture/CURRENT_ARCHITECTURE_STATE.md) |
| W3C `$type`s | [W3C_CONFORMANCE.md](docs/domain/W3C_CONFORMANCE.md) |
| Mood board | [MOOD_BOARD_SPECIFICATION.md](docs/features/MOOD_BOARD_SPECIFICATION.md) |
| Shadow regen | [shadow/GETTING_STARTED.md](docs/shadow/GETTING_STARTED.md) |
| Tests | [TESTING_GUIDE.md](docs/testing/TESTING_GUIDE.md) |

**Repo:** [joshband/copy-that](https://github.com/joshband/copy-that) · **API:** http://localhost:8000/docs · **Health:** `/health`
