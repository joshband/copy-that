...
import {
  ...
  type LightingGeometryImages,
  type LightingGeometryMeta,
} from './LightingGeometryEvidence'
...
interface LightingAnalysis {
  ...
  geometry_meta?: LightingGeometryMeta | null
  geometry_images?: LightingGeometryImages | null
}
...
export default function LightingAnalyzer({
  ...
  // Auto-analyze when image is provided (parked for MVP unless flag on)
  useEffect(() => {
    if (!featureFlags.showLightingAnalyzer) return
  ...
  return (
    <div className="lighting-analysis">
      ...
      <LightingGeometryEvidence
        geometryUsed={analysis.geometry_used}
        geometryMeta={analysis.geometry_meta}
        geometryImages={analysis.geometry_images}
      />
