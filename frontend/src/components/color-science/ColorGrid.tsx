          ...
          >
            ...
            <div className="color-info">
              ...
              <div className="color-tags">
                {formatConfidence(color.confidence) ? <span className="tag confidence">{formatConfidence(color.confidence)}</span> : null}
        ...
        {spacingTokens.map((t, idx) => (
          <div key={idx} className="color-card">
            <div className="color-info">
              ...
              <div className="color-tags">
                {formatConfidence(t.confidence) ? <span className="tag confidence">{formatConfidence(t.confidence)}</span> : null}
