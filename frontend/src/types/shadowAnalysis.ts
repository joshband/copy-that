...
export interface LightingAnalysisResponse {
  ...
  /** True when real P4 geometry depth/normals were applied */
  geometry_used?: boolean
  /** Geometry extract meta (depth_model, normals_source, …) */
  geometry_meta?: Record<string, unknown> | null
  /** Optional PNG base64 previews: depth_png, normals_png */
  geometry_images?: {
    depth_png?: string
    normals_png?: string
  } | null
