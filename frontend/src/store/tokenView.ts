...
import { useTokenUIStore, type TokenType, type TokenUIState } from './uiStore'
...
export const useTokenViewState = () => {
  const ui = useTokenUIStore(
    useShallow((s) => ({
      ...
      playgroundOpen: s.playgroundOpen,
      playgroundToken: s.playgroundToken,
      playgroundActiveTab: s.playgroundActiveTab,
      togglePlayground: s.togglePlayground,
      setPlaygroundTab: s.setPlaygroundTab,
      setPlaygroundToken: s.setPlaygroundToken,
      applyPlaygroundChanges: s.applyPlaygroundChanges,
      resetPlayground: s.resetPlayground,
    })),
  )
