    ...
    <>
      ...
      <div className="palette-grid">
        {colors.map((color, index) => {
          const confidenceLabel = formatConfidence(color.confidence)
          return (
            <div
              key={index}
            ...
            >
              ...
              <div className="swatch-info">
                ...
                {confidenceLabel ? (
                  <span className="swatch-confidence">{confidenceLabel}</span>
                ) : null}
                {(color.background_role ||
                  ...
                  <div className="swatch-badges">
                    ...
                    {color.foreground_role && <span className="badge fg">text</span>}
                    {(color as any)?.extraction_metadata?.accent && (
