...
class TestAnalyzeImageForShadows:
    ...
    def test_analysis_with_geometry(self):
        """Test analysis with real geometry extract (mocked P4 path)."""
        ...
        fake = {
            "depth01": np.ones((100, 100), dtype="float32") * 0.5,
            "normals_xyz": np.zeros((100, 100, 3), dtype="float32"),
    ...
    def test_different_images_give_different_results(self):
        ...
        result1 = analyze_image_for_shadows(image1, use_geometry=False)
        result2 = analyze_image_for_shadows(image2, use_geometry=False)
