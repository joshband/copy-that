...
@pytest.mark.asyncio
async def test_design_tokens_export_css(client, async_db, project):
    """Ensure /design-tokens/export/css returns CSS custom properties."""
    color = ColorToken(
        project_id=project.id,
        hex="#112233",
        rgb="rgb(17, 34, 51)",
    ...
    assert data["filename"] == "tokens.css"
