...
from copy_that.infrastructure.persistence.models import ExtractionJob, Project
from copy_that.infrastructure.persistence.models import SpacingToken as DBSpacingToken
