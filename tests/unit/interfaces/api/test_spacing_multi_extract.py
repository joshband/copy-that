"""API contract tests for spacing multi-extractor endpoint."""
...
async def test_project(async_db):
    project = Project(name="Spacing Multi", description="multi extract")
...
@pytest.mark.asyncio
async def test_spacing_extract_multi_endpoint_exists(client, test_project, tiny_png_b64):
    resp = await client.post(
        "/api/v1/spacing/extract/multi",
