...
def test_github_actions_environment_detection():
    ...
    github_action_cases = [
        ...
        {"GITHUB_ACTIONS": "true", "GITHUB_EVENT_NAME": "pull_request", "expected": "staging"},
...
def test_configuration_error_handling(caplog):
    ...
    error_scenarios = [
        ...
        {"mock_path": "/nonexistent/path", "expected_log": "Failed to create directory"},
        # Scenario 2: Failed to create file
        {"mock_path": "/nonexistent/unreachable.env", "expected_log": "Failed to create file"},
    ]
