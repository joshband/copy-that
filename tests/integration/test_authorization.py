...
class TestResourceOwnership:
    ...
    @pytest.mark.asyncio
    async def test_owner_can_access_project(self, client: AsyncClient, user_with_project):
...
class TestRoleBasedAccess:
    ...
    @pytest.mark.asyncio
    async def test_user_role_can_create_project(self, client: AsyncClient, other_user):
    ...
    @pytest.mark.asyncio
    async def test_admin_has_elevated_access(self, client: AsyncClient, admin_user):
