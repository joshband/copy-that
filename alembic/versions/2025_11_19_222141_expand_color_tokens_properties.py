...
down_revision: str | Sequence[str] | None = "2025_11_19_001"
...
def upgrade() -> None:
    ...
    op.add_column(
        "color_tokens", sa.Column("saturation_level", sa.String(length=20), nullable=True)
    )
    op.add_column("color_tokens", sa.Column("lightness_level", sa.String(length=20), nullable=True))

    # Count & prominence
    op.add_column(
        "color_tokens", sa.Column("count", sa.Integer(), nullable=False, server_default="1")
    )
    ...
    op.add_column(
        "color_tokens", sa.Column("wcag_aa_compliant_normal", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "color_tokens", sa.Column("wcag_aaa_compliant_normal", sa.Boolean(), nullable=True)
    )
    ...
    op.add_column(
        "color_tokens", sa.Column("closest_css_named", sa.String(length=50), nullable=True)
    )
