...
Note: token_libraries.session_id index already exists from 2025_11_20_006
"""
...
def upgrade() -> None:
    ...
    # Token libraries - session_id index already exists from 2025_11_20_006
...
def downgrade() -> None:
    ...
    # Note: ix_token_libraries_session_id managed by 2025_11_20_006
